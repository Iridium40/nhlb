    ...
    <Html>
      ...
      <Body style={{ fontFamily: 'Arial, sans-serif', background: '#f4f4f4', padding: '32px 0' }}>
        <Container style={{ background: '#fff', borderRadius: 8, padding: '32px', maxWidth: 480 }}>
          <Heading style={{ fontSize: 20, marginBottom: 4 }}>New booking request</Heading>
          ...
          <Section>
            ...
            <Text style={{ margin: '4px 0' }}>
              <strong>Format:</strong> {booking.session_format === 'virtual' ? '💻 Virtual' : '📍 In Person'}
            </Text>
          ...
          <Text style={{ color: '#999', fontSize: 12 }}>
            Booking ID: {booking.id} &mdash; Log in to the admin dashboard to confirm or reschedule.
          </Text>
        </Container>
      </Body>
    </Html>
