    ...
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--nhlb-cream)' }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '32px 24px' }}>
        ...
        {loading ? (
          ...
          <>
            <p style={{ fontFamily: 'Raleway, sans-serif', fontSize: '0.8rem', color: 'var(--nhlb-muted)', marginBottom: 12 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                      ...
                      <div style={{ textAlign: 'right', flexShrink: 0 }}>
                        <div style={{ display: 'flex', gap: 6, justifyContent: 'flex-end', flexWrap: 'wrap' }}>
                          ...
                          <span style={{
                            padding: '3px 10px', borderRadius: 20, fontSize: '0.7rem', fontWeight: 700,
                            fontFamily: 'Raleway, sans-serif', backgroundColor: '#D1FAE5', color: '#065F46',
                          }}>
                            {c.session_count} session{c.session_count !== 1 ? 's' : ''}
                          </span>
                        </div>
                        {c.last_session_at && (
                          <p style={{ fontFamily: 'Raleway, sans-serif', fontSize: '0.7rem', color: 'var(--nhlb-muted)', margin: '4px 0 0' }}>
